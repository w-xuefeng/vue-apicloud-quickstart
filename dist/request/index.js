...
var NetworkRequest = /** @class */ (function () {
    ...
    NetworkRequest.prototype.request = function (opts) {
        var _this = this;
        var isHttpUrl = function (url) { return ['https://', 'http://', '//'].some(function (e) { return url.startsWith(e); }); };
        ...
        if (typeof api !== "undefined") {
            ...
            if (!isContinue_1)
                return new Promise(function (resolve, reject) { return reject(isContinue_1); });
            ...
            var isContinue_2 = this.interceptor(this.requestOptions);
            if (!isContinue_2)
                return new Promise(function (resolve, reject) { return reject(isContinue_2); });
